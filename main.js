...
class HttpConnectionService {
    ...
    Login(userLogin) {
        return this._HttpClient.post('http://localhost:3000/users/login', userLogin);
    }
    addNewContactInfo(contact) {
        return this._HttpClient.post('http://localhost:3000/contacts', contact);
    }
    getProducts() {
        return this._HttpClient.get('http://localhost:3000/products');
    }
    getProductsByCategory(strCategory) {
        return this._HttpClient.get('http://localhost:3000/products/' + { strCategory });
    }
    addProduct(productObj) {
        return this._HttpClient.post('http://localhost:3000/products', productObj);
    }
    getProductById(id) {
